...
BEGIN_TEST(assembler.smem)
   for (amd_gfx_level gfx : filter_gfx_levels({GFX11, GFX12})) {
      ...
      ac_hw_cache_flags cache_coherent = {ac_glc};
      ac_hw_cache_flags cache_non_temporal = {ac_dlc};
...
BEGIN_TEST(assembler.mubuf)
   for (amd_gfx_level gfx : filter_gfx_levels({GFX11, GFX12})) {
      ...
      /* Various flags */
      ac_hw_cache_flags cache_coherent = {ac_glc};
      ac_hw_cache_flags cache_sys_coherent = {ac_slc};
      ac_hw_cache_flags cache_non_temporal = {ac_dlc};
      ac_hw_cache_flags cache_atomic_rtn = {ac_glc};
