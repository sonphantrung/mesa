                                   ...
                                   VkPhysicalDeviceProperties2 *pProperties)
{
   ...
   const VkPhysicalDeviceLimits limits = {
      /* Maximum texture dimension is 2^16, but we're limited by the maxium
       * framebuffer size here, which is 2^14.
       */
      ...
      /* Limited by the texture size, which is 2^16. */
      ...
      /* MALI_RENDERER_STATE::uniform_buffer_count is 8-bit. */
      .maxPerStageDescriptorUniformBuffers = UINT8_MAX,
      .maxDescriptorSetUniformBuffers = UINT8_MAX,
   ...
   pProperties->properties = (VkPhysicalDeviceProperties){
      ...
      /* Collect arch_major, arch_rev and product_major, as done by the Arm
       * driver, mask the rest.
       */
      .deviceID = (pdevice->kmod.props.gpu_prod_id << 16) & 0xf0ff0000,
